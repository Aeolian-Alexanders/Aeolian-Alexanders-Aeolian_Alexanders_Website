...
<html lang="en">
<head>
  <title>Aeolian Alexanders: Obverse Die Information</title>
  <meta charset="utf-8">
...
<?php
  ...
  $id = strval($_GET["obverse_id"]);
  //$id = '1';
  $sth = $pdo->prepare('SELECT coinid FROM all_coins WHERE obvdie = :parameter');
...
foreach ($obverseids as $row) {
  echo '<div class="col-lg-3 col-md-4 col-6">';
    ...
    echo '<img class="img-fluid img-thumbnail" src="https://raw.githubusercontent.com/Aeolian-Alexanders/coins/master/images/'.$row["coinid"].'_o.png" alt="coin obverse image">';
    echo '</a>';
    echo '</div>';
}
